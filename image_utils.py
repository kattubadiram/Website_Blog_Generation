...
def get_advanced_content_aware_image(blog_text: str, summary_text: str, title: str) -> str:
    ...
    image_categories = {
        ...
        "federal_reserve": [
            ...
            "https://unsplash.com/photos/a-large-white-building-with-a-flag-on-top-of-it-2_4Tp9YaawM"
            "https://unsplash.com/photos/a-large-building-with-columns-and-a-flag-on-the-corner-Skfy8ljB7X4"
        ],
