...
def generate_blog(market_summary: str, section_count: int = 1):
    ...
    for i in range(section_count):
        system_msg = {
            "role": "system",
            "content": (
                f"You are a senior science and technology journalist writing for a well-informed audience about The Stargate Project by open ai. Write the section titled '{section_titles[i]}'.\n\n"
